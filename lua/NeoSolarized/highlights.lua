...
local o = vim.o
local fn = vim.fn
local utils = require('NeoSolarized.utils')
local colors
...
function M.load_syntax(colors)
  ...
  elseif g.solarized_visibility == 'low' then
    ...
    syntax['NonText'] = { fg = colors.base01, style = utils.italics() }
    syntax['SpecialKey'] = { fg = colors.base01, style = utils.italics() }
    syntax['SpellBad'] = { fg = colors.violet, guisp = colors.violet, style = 'underline' }
    syntax['SpellCap'] = { fg = colors.violet, guisp = colors.violet, style = 'underline' }
    syntax['SpellLocal'] = { fg = colors.yellow, guisp = colors.yellow, style = 'underline' }
    syntax['SpellRare'] = { fg = colors.cyan, guisp = colors.cyan, style = 'underline' }
  ...
  syntax['CursorColumn'] = { fg = colors.none, bg = colors.none }
  ...
  syntax['LineNr'] = { fg = colors.base01, bg = utils.lineNr(colors.base02) }
  ...
  syntax['Visual'] = { fg = colors.base01, bg = colors.base02 }
  syntax['VisualNOS'] = { fg = colors.base01, bg = colors.base02 }
  ...
  syntax['InsertMode'] = { fg = colors.none, bg = colors.base01, style = 'bold,reverse' }
  ...
  syntax['TSKeywordFunction'] = syntax['Include']
  ...
  syntax['CmpItemKindConstant'] = { fg = colors.magenta, bg = colors.none }
  syntax['CmpItemKindReference'] = { fg = colors.base3, bg = colors.none }
  ...
  syntax['CmpItemKindInterface'] = { fg = colors.violet, bg = colors.none }
  syntax['CmpItemKindStruct'] = { fg = colors.red, bg = colors.none }
  syntax['CmpItemKindEvent'] = { fg = colors.violet, bg = colors.none }
  syntax['CmpItemKindEnum'] = { fg = colors.orange, bg = colors.none }
  syntax['CmpItemKindUnit'] = { fg = colors.orange, bg = colors.none }
  syntax['CmpItemKindModule'] = { fg = colors.cyan, bg = colors.none }
  syntax['CmpItemKindProperty'] = { fg = colors.magenta, bg = colors.none }
  syntax['CmpItemKindField'] = { fg = colors.violet, bg = colors.none }
  ...
  syntax['CmpItemKindOperator'] = { fg = colors.yellow, bg = colors.none }
